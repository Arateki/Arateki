...
cp apps/web/.env.example apps/web/.env # Asegúrese de que VITE_GOOGLE_SCRIPT_URL esté configurado
```
...
- **Pruebas de Unidad**: `pnpm test`
- **E2E y Regresión Visual**: `pnpm test:e2e`
- **Informe de Cobertura**: `pnpm test:coverage`
